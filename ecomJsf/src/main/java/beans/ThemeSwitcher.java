...
public class ThemeSwitcher {
    ...
    public Boolean getCheckedDBForTheme() {
        return checkedDBForTheme;
    }

    public void setCheckedDBForTheme(Boolean checkedDBForTheme) {
        this.checkedDBForTheme = checkedDBForTheme;
    }
