...
<head>
    ...
    <meta name="description" content="Struts2 Bootstrap Plugin Showcase - NTT Data" />
    <title>Gestion des Ressources Humaines - NTT Data</title>
...
<s:include value="includes/topMenu.jsp">
    <s:param name="active">home</s:param>
        ...
        <div class="col-md-9">
            ...
            <h1>Gestion des Ressources Humaines - NTT Datae</h1>
